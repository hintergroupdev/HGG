      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {(settings?.linkedinUrl || settings?.twitterUrl || settings?.facebookUrl || settings?.instagramUrl || settings?.youtubeUrl) && (
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li>
                <Link href="/about-us#strategic-approach" className="text-slate-300 hover:text-[#DFB758] transition-colors">
                  6-Stage Strategic Approach
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li>
                <Link href="/about-us#waste-management" className="text-slate-300 hover:text-[#DFB758] transition-colors">
              ...
              <li>
                <Link href="/about-us#areas-of-focus" className="text-[#57A3C0] hover:text-[#9DE9FC] transition-colors inline-flex items-center gap-1 font-medium text-xs">
                  View All 9 Focus Areas <ArrowUpRight className="w-3 h-3" />
                </Link>
              </li>
            </ul>
          </div>
