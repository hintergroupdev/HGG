...
export const metadata = {
  ...
  description:
    "Connect with THE HINTER GROUP GHANA LTD at 8 Teinor Street, Dzorwulu, Accra, Ghana. Submit commercial proposals, institutional inquiries, and explore cross-border partnership opportunities.",
  alternates: {
