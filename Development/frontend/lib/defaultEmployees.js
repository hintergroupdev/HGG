...
export const defaultVerifiedEmployeesList = [
  ...
  },
  {
    ...
    position: 'Executive Leadership Team — Strategic Coordination & Stakeholder Engagement',
    organization: 'THE HINTER GROUP GHANA LTD',
    department: 'Executive Leadership & Governance',
    status: 'active',
    isExecutive: true,
  ...
  },
  {
    ...
    position: 'Executive Leadership Team — Strategic Development & Business Coordination',
    organization: 'THE HINTER GROUP GHANA LTD',
    department: 'Executive Leadership & Governance',
    status: 'active',
    isExecutive: true,
